     ...
     tools {
      ...
      stages {
        ...
        stage('Build solution') {
          ...
          stage('Publish HTML'){
            steps{
             reportgenerator -reports:**/**/coverage.cobertura.xml -targetdir:"Test/CoverageReport" -reporttypes:"Html;JsonSummary;TextSummary" -classfilters:-AutoGeneratedProgram
            }
          }
         }
      post {
